...
#*******************************************************************************
   ...
   a) Commit the "old" application version as "INIT 03_advanced" in the "develop" branch

   b) Update one of your modules using classes.
...
#*******************************************************************************
   ...
   a) Update one of your modules using configuration or data files.

   b) Write a comment in the call of the configuration file
      why a configuration or data file would improve this module.

   c) Commit as "DONE 03_advanced" and push the updated version to "main/master".
